...
let todoInputHandler = function() {
    ...
    // localStorage의 key값은 todoNum으로, setting value는 todo 객체를 JSON.stringfy() 이용해서 String으로 변경하여 저장
    // ex) key: 1, value: { "todoNum": 1, "title": "일정" }
...
function displayList() {
    ...
    todoList.innerHTML = initTodoList;
}